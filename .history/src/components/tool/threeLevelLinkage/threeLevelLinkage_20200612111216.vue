<template>
  ...
  <div class="threeLevelLinkage" v-if="!showVal === false">
    <div class="calendar">
      <div class="textDemo">
        {{ nowCity.province }}{{ nowCity.city }}{{ nowCity.area }}
      </div>
      <div class="title">
      ...
      <div class="body" ref="width">
        ...
        <div id="wrapper" class="body-month">
          <ul>
            <li></li>
            <li></li>
            <li v-for="(item, index) in cityData.province" :key="index">
              {{ item }}
            </li>
            <li></li>
            <li></li>
        ...
        <div id="wrapper1" class="body-month">
          <ul>
            <li></li>
            <li></li>
            <li v-for="(item, index) in cityData.city" :key="index">
              {{ item }}
            </li>
            <li></li>
            <li></li>
        ...
        <div id="wrapper2" class="body-month">
          <ul>
            <li></li>
            <li></li>
            <li v-for="(item, index) in cityData.area" :key="index">
              {{ item }}
            </li>
            <li></li>
            <li></li>
...
import IScroll from "@types/iscroll/index";
...
export default class ThreeLevelLinkage extends Vue {
  ...
  bindScroll(e: number) {
    ...
    if (e === 0) {
      ...
      const nowSub: SubScript = self.nowSubScript;
      self.iscroll.scrollTo(0, (-self.Width / 10) * (nowSub.x as number), 500);
      self.iscroll1.scrollTo(0, (-self.Width / 10) * (nowSub.y as number), 500);
      self.iscroll2.scrollTo(0, (-self.Width / 10) * (nowSub.z as number), 500);
      setTimeout(() => {
        self.isMask = false;
